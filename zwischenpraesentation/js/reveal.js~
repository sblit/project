...
(function( root, factory ) {
	...
	/**
	 * Opens a preview window for the target URL.
	 * TODO manually modified by Martin Exner 2015-01-27
	 */
	function showIframe(url, header) {
		...
		if(header) {
			...
			dom.overlay.innerHTML = [
				'<header style="border-bottom: 0; height: 0;">',
					'<a class="close" href="#"><span class="icon" style="-webkit-filter: invert();"></span></a>',
				'</header>',
	...
	function showSlide( slide ) {
		...
		if( background ) {
			...
			// TODO manually added by Martin Exner 2015-01-27
			...
			if( background.hasAttribute( 'data-loaded' ) === false ) {
				...
				// Iframes
					...
					// TODO manually added by Martin Exner 2015-01-27
					//document.querySelector('.reveal > .backgrounds').style['z-index'] = 1000;
				}
			}
		}
	...
	Reveal = {
		...
		configure: configure,
		sync: sync,
		showIframe: function(url) { showIframe(url, false); }, // TODO manually added by Martin Exner on 2015-01-27
		closeIframe: closeOverlay, // TODO manually added by Martin Exner on 2015-01-27
