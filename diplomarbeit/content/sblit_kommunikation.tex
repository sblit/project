...
Nachdem der \gls{partfileres} empfangen wurde, wird, falls das Need-Flag auf \code{0x01} gesetzt ist, wird mit der \gls{partfilemsg} geantwortet. Bevor die \gls{partfilemsg} verschickt wird, werden der Dateiinhalt, Dateipfad und die Geräte mit der aktuellen Version mit dem symmetrischen Schlüssel verschlüsselt \referenz{sicherheit}.
