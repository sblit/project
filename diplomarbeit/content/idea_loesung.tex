...
die Information, wo die gesamten Blöcke gespeichert sind. % und in welcher Reihenfolge man diese wieder zusammensetzen muss.
...
%Blöcke gehören.
%TODO entfernen bei der Überschrift
\subsection{Szenarios (stimmt noch nicht und wird überarbeitet)}
\subsubsection{Allgemein}
