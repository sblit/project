...
\newcommand{\kap}[1]{\text{Kapitel} \link{#1}}
...
\newcommand{\descriptionitem}[1]{\needspace{2\baselineskip} \item[{#1}] \hfill \\}
...
\input{content/_defs_bytefields.tex}
...
\newcommand{\listingstart}[1]{\javalisting \listingneedspace \begin{lstlisting}[caption={#1},captionpos=b]}
