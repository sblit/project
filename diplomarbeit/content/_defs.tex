...
\newcommand{\startmessage}{\begin{figure}[H] \begin{centering} \begin{bytefield}[bitwidth=3em]{8} \\}
\newcommand{\endmessage}[1]{\end{bytefield} \par\end{centering} \protect\caption{#1} \end{figure}}
