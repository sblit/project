\includegraphics[]{config_gui.png}

\begin{description}
	
	\item[{Geräte zu den Synchronisationspartnern hinzufügen/entfernen \includegraphics[]{images/legendennr_1_text}]\label{configgui3}
...
Mit der Import- beziehungsweise der Export-Funktion der Liste, soll dem User das Übertragen der Liste auf neue Geräte erleichtert werden.
	...
	\item[{Manuelles Eintragen von Partnergeräten \includegraphics[]{images/legendennr_2_text}]\label{configgui3}
	...
	\item[{Verschieben des sblit-Ordners \includegraphics[]{images/legendennr_3_text}]\label{configgui3}
