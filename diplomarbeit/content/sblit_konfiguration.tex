...
\begin{description}
	...
	Der Parameter \code{file} legt die Datei fest, die die Adressen der Partnergeräte enthält. Diese Parametrisierung ist deswegen notwendig, weil die Methode \code{updateDevices(file, devices)} auch für das Schreiben von receivers.txt \referenz{receivers} verwendet wird.
