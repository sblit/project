...
\begin{lstlisting}[caption={Adressverkürzung (Java)},captionpos=b]
...
\begin{description}
	...
	\item [{\code{address}:}]
		Das \javaarg \code{address} referenziert ein \code{Address}-Objekt, welches den als
		Grundlage für eine Adresse verwendeten öffentlichen Schlüssel beinhaltet.
	...
	\item [{\code{byteLength}:}]
		Die Instanzvariable \code{byteLength} beinhaltet die Ziellänge der Adressen, in bytes.
