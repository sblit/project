...
entworfen und gedruckt (\siehe{appendix3}).
...
beschreibt und noch nähere technische Details zu den einzelnen Teilgebieten und den Projektstatus beinhaltet (\siehe{appendix2}).
...
Dokumentation als Abgabe gefordert. Aufgrund dessen wurde auch hier der Projektfolder eingereicht (\siehe{appendix2}).
