...
beschreibt und noch nähere technische Details zu den einzelnen Teilgebieten und den Projektstatus beinhaltet (\siehe{appendix}).
...
Dokumentation als Abgabe gefordert. Aufgrund dessen wurde auch hier der Projektfolder eingereicht (\siehe{appendix}).
